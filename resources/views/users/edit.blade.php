                ...
                <div class="row">
                    ...
                    @if($user->perfil->nome == 'aluno')
                        <div class="form-group col-sm-6">
                            ...
                            <input type="telefone" class="form-control @error('telefone') is-invalid @enderror"  id="telefone" name="telefone" value="{{ $user->perfil->telefone }}">
                            @error('telefone')<div class="invalid-feedback"> {{ $message }}</div>@enderror
                        </div>

                        <div class="form-group col-sm-6">
                            <label for="data_nascimento">Data de Nascimento: </label>
                            <input type="date" class="form-control @error('data_nascimento') is-invalid @enderror"  id="data_nascimento" name="data_nascimento" value="{{ $user->perfil->data_nascimento }}">
                            @error('data_nascimento')<div class="invalid-feedback"> {{ $message }}</div>@enderror
                        </div>

                        <div class="form-group col-sm-6">
                            <label for="cpf">CPF: </label>
                            <input type="cpf" class="form-control @error('cpf') is-invalid @enderror"  id="cpf" name="cpf" value="{{ $user->perfil->cpf }}">
                            @error('cpf')<div class="invalid-feedback"> {{ $message }}</div>@enderror
                        </div>

                        <div class="form-group col-12">
                            <label for="biografia">Biografia: </label>
                            <textarea class="form-control @error('biografia') is-invalid @enderror"  id="biografia" name="biografia">{{ $user->perfil->biografia }}</textarea>
